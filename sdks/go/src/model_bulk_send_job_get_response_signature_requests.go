...
func (o *BulkSendJobGetResponseSignatureRequests) GetSigningRedirectUrl() string {
	if o == nil || o.SigningRedirectUrl.Get() == nil {
		var ret string
		return ret
	}
